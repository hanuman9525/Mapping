...
@Entity
@Table(name = "PassportOneToOneJointable_tbl")
public class PassportOneToOneBi {
	...
	@OneToOne
	@JoinTable(name = "Passport_person_tbl", joinColumns = @JoinColumn(name = "passportId") , inverseJoinColumns = @JoinColumn(name = "passport") )
